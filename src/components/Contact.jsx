        ...
        <div className="bg-white/90 dark:bg-white/5 backdrop-blur-sm rounded-none p-12 border border-blue-300/70 dark:border-white/10 hover:border-rose-400/60 dark:hover:border-amber-300/30 transition-all duration-700 hover:bg-gradient-to-b hover:from-amber-400/20 hover:to-rose-400/20 dark:hover:from-amber-500/10 dark:hover:to-rose-500/10">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-y-0 sm:space-x-8">
            <a
              ...
              className="flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-amber-400/30 to-rose-400/30 dark:from-amber-400/20 dark:to-rose-400/20 border border-rose-400/50 dark:border-amber-300/30 rounded-none hover:from-amber-400/40 hover:to-rose-400/40 dark:hover:from-amber-400/30 dark:hover:to-rose-400/30 hover:border-rose-400/60 dark:hover:border-amber-300/50 transition-all duration-500 transform hover:scale-105 backdrop-blur-sm text-gray-900 dark:text-amber-100 font-light tracking-wide text-sm"
            >
            ...
            <div className="flex space-x-6">
              <a
                ...
                className="p-4 bg-white/80 dark:bg-white/10 rounded-none hover:bg-gradient-to-r hover:from-amber-400/30 hover:to-rose-400/30 dark:hover:bg-amber-500/20 border border-transparent hover:border-rose-400/50 dark:hover:border-amber-300/30 transition-all duration-500 hover:scale-110 backdrop-blur-sm"
              >
                <Github className="w-6 h-6 text-gray-800 dark:text-amber-100" />
              </a>
              <a
                target="_blank"
                ...
                className="p-4 bg-white/80 dark:bg-white/10 rounded-none hover:bg-gradient-to-r hover:from-amber-400/30 hover:to-rose-400/30 dark:hover:bg-amber-500/20 border border-transparent hover:border-rose-400/50 dark:hover:border-amber-300/30 transition-all duration-500 hover:scale-110 backdrop-blur-sm"
              >
                <Linkedin className="w-6 h-6 text-gray-800 dark:text-amber-100" />
              </a>
              <a
                target="_blank"
